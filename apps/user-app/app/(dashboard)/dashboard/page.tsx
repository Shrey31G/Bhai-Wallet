...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-purple-600 text-white p-6 shadow-md rounded-b-md">
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
            <div className="bg-purple-100 p-4">
              <h2 className="text-purple-800 font-medium text-lg">Current Balance</h2>
            </div>
            <div className="p-6 flex items-center justify-center">
              {status === "loading" || loading ? (
                ...
                <div className="text-center text-gray-500">
                  <p>Sign in to view your balance bhai</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="bg-purple-100 p-4">
              <h2 className="text-purple-800 font-medium text-lg">About Bhai Wallet</h2>
            </div>
            <div className="p-6">
              <p className="text-gray-700 mb-4">
                Bhai Wallet is your all-in-one digital wallet solution that makes financial transactions simple, secure, and instant.
              </p>
